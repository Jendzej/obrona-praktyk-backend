...
class Database:
    ...
    def create_models(self, base):
        ...
        return [Items, SchoolClasses, Roles, Users, Transactions]
...
print(db.add_transaction(transactions_model, "jendrzej24", 13.43, "Przedmiot 5; Przedmiot 6", datetime.date.today()))